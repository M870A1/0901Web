...
public class Ex17_ArrysObjSort {
	...
	public static void main(String[] args) {
		...
		Arrays.sort(intArr);// 오름차순 정렬 (작->큰 순서)
		System.out.println(Arrays.toString(intArr));
//		내림차순,래퍼클래스로된 자료형만 실행 가능
		Arrays.sort(intArr, Collections.reverseOrder()); // 내림차순 정렬 (큰->작 순서)
		System.out.println(Arrays.toString(intArr));

//	문자열 정렬하기
		String[] strArr = { "kwiw", "apple", "melon", "banana" };
		...
		System.out.println(Arrays.toString(strArr));
		// 글자 수 순으로 정렬하기
		String[] strArr2 = { "a", "abc", "abcde", "ab", "abcd" };
