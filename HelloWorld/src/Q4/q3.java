...
//		사용자가 정수를 입력하지 않는 경우에는 프로그램을 종료하라. [목적-자바의 예외 처리 연습] 
//				[난이도 하] 
//				정수를 입력하세요>>352 
//				짝수 
...
//		예처리 try catch문 사용하여 예외가 발생하더라도
...
//		chtch(Exception e ){에러가 발생했을때 실행할 코드 작성
...
System.out.println("정상실행,chtch문 실행이 끝나고 나면 실행되는부분");
	}
