...
//			catch문의 경우 예외의 종류를 바꾸면 몇개든 작성할 수 있다.
//				 InputMismatchException이 발생했을때 실행할 코드
			System.out.println("문자를 입력하거나 21억이 넘는 숫자를 입력하지 마시오");
		} catch (Exception e) {
...
System.out.println("try catch문이 끝난 후 실행 됩니다.");


//		컴파일 에러 : 컴파일 실행시 발생하는 예외, 이클립스의 경우 빨간색 줄로 표시한다.
