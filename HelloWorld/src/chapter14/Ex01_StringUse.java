...
//		.equals() 이퀄스: String안의 문자열을 비교하는 메서드
		if (str1.equals(str2)) {
...
//		대소문자를 구분하지 않고 문자열을 비교하는 메서드
		...
		String str6 = "apple";
		if (str5.equals(str6)) {
			System.out.println("equals : str5와str6은 동일한 문자열");
		}

		if (str5.equalsIgnoreCase(str6)) {
			System.out.println("equalsIgnoreCase : str5와str6은 동일한 문자열");
		}
...
//		문자열 자르기
		...
		System.out.println(str.substring(5, 10 + 1));// 5번 위치부터 10번 까지
		System.out.println(str.substring(str.indexOf("Banana"), str.indexOf("Orange")));
//	아래의 전화번호를 각각 출력해보자
		String tel = "051-718-1234";
...
// 251016 : 연월일을 각각 출력해보자
		String num = "251016";
		System.out.println(num.substring(0, 1 + 1) + "년");
		System.out.println(num.substring(2, 3 + 1) + "월");
		System.out.println(num.substring(4) + "일");
...
//		replace("바뀌기 전 문자열","바꾼 후 문자열" 특정 문자열 변경하기 메서드
...
// 특정 문자를 기준으로 나누는 메서드 
		str = "010-1234-5678";
		String[] strArr = str.split("-"); // split 을 - 로 지정하여 -를 기준으로 나눔
		System.out.println(Arrays.toString(strArr));
		str = "홍길동,이순신,강감찬";
		strArr = str.split(",");
		System.out.println(Arrays.toString(strArr));
//	StringTokenizer : 특정 문자를 기준으로 나누는 *클래스*(아무런 조건없으면 공백을 기준)
