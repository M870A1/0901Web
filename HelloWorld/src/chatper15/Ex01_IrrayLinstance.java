...
public class Ex01_IrrayLinstance {
...
//		 배열이름[위치값] = 저장할값;
//       개수가 5 라면 위치값은 0부터 시작하고 4까지 5개 의 위치값을 사용할 수 있음.
		array[0] = 10;
		array[1] = 20;
		array[2] = 30;
		array[3] = 40;
...
//		 배열 데이터 출력하기: 변수이름 뒤에 대광호를 적고 출력하고 싶은 위치값을 작성
		System.out.print(array[0]);
		System.out.print(array[1]);
		System.out.print(array[2]);
		System.out.print(array[3]);
		System.out.print(array[4]);
//		 System.out.println(array[5]); 5번 데이터는 존재 하지 않음으로 에러 발생
...
//모든데이터 출력시	 for(배열의자료형 배열데이터변수이름 : 배열이름) { 실행할 코드; }
		for (int i : intArr2) {
			System.out.print(i + " ");
		}
