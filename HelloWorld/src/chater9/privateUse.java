...
class Student1 {
	// 접근제한자를 생략하는 경우 : 같은 패키지의 클래스는 데이터를 변경하거나 사용할 수 있다.
	String name;
	int age;
}
...
class Student2 {
	...
	public String name;
	// private: 현재 클래스에서만 자유롭게 사용할 수 잇도록 만드는 접근 제한자
	private int age;
...
public class privateUse {
	...
	public static void main(String[] args) {
		...
		student2.name = "손오공";
		// age는 private 으로 설정했기 때문에 사용할 수 없음, 에러 발생
//		student2.age = -10;
		student2.setAge(-10);
